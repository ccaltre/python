...
df = pd.read_excel(r"C:\Users\ccalatayudtrescoli\OneDrive - Deloitte (O365D)\Documents\github_python\python\MachineLearning\MyTests\SVM\SVC_Classification.xlsx", sheet_name="Lineal")
